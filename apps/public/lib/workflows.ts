/**
 * Workflow event dispatcher (public-app copy).
 *
 * Mirrors apps/admin/lib/workflows.ts. Kept duplicated to avoid a shared
 * package — both files must move in lockstep. Public dispatches lead.created
 * and quote.signed events; admin dispatches lead.stage.changed and quote.sent.
 */
