-- ============================================================================
-- 0036_fix_public_views_matterport_and_options.sql
-- Fix: migration 0030_configurable_beds_baths recreated public_homes and
-- public_marketplace_homes without matterport_url (added by 0030_homes_matterport_url).
-- This migration recreates both views with ALL columns.
-- ============================================================================
...
-- 2. Recreate public_homes with matterport_url + beds_options + baths_options
...
-- 4. Recreate public_marketplace_homes with all columns
